...
<div class="minimum-3-three" style="margin-right:30px;">  
    ...
    <div class="col-md-4">  
        <div class="row"> 
            <div class="col-md-12 rectangle-1a"  style="margin-bottom: 5%"><br>   
              <p class="project-manager" style="margin: 3%;height:70px; "> <b> {{$detailCareer->job_title}} </b></p>
              <div class="" style="margin:3%;margin-top:7%; ">
        ...
        <div class="row"> 
          <div class="col-md-12 rectangle-6-copy-2"> 
            <p class="need-further-informa"> Need further information about us?</p><br> 
                        <p style="padding-left: 5%;"><a href="{{url('/contact-us')}}" class="text-white button button-2-b" style="padding: 18px 50px 18px 50px;"><span>Contact Us</span></a></p>   
          </div>
